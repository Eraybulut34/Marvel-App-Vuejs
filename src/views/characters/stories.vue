...
export default {
  ...
  methods: {
    getComics() {
      axios
        .get(
          "https://gateway.marvel.com/v1/public/characters/"+this.characterID+"/stories?ts=100&apikey=9ba68562b5c70ba6442264f6c5add1c2&hash=cdf3beb7b14c2e38b26b3f2fdef6a2ee"
        )
        .then((response) => {
