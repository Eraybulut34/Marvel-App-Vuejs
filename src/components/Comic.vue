  ...
  <div class="character-page">
    <div v-for="char in character" :key="char.id">
      ...
      <nav class="navbar-lower">
        <router-link to="/characters" class="route-item"> COMICS </router-link>
        <router-link to="/comics" class="route-item"> EVENTS </router-link>
        <router-link to="/events" class="route-item"> SERIES </router-link>
        <router-link to="/creators" class="route-item"> STORIES </router-link>
      </nav>
